  ...
  return (
    <Link className="article-link" to={"/articles/" + mediumArticle.id}>
      <div className="medium-article">
        ...
        <img className="medium-article-img" src={mediumArticle.picture ? ("https://ujp-sports-hub.herokuapp.com/api/v1/image/" + mediumArticle.picture) : mediumArticlePhoto} alt="article-img" />
